	...
	return (
		<div>
			<div className="flex flex-col items-center mt-10 gap-4 animate-fade-in text-white">
				<h1 className="font-bold text-5xl font-serif text-n-purple"> Hej och Välkommen!</h1>
			...
			<div className="mt-20 md:flex">
				<img src="https://via.placeholder.com/300x300/" alt="placeholder" className="ml-10" />
				<div className="ml-8">
